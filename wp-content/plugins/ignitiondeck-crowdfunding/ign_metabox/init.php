...
//									'<div></div>';
				...
				break;
				case 'add_levels':
					echo '	<div class="submitbox"> <span addlevel="1" class="ig-add-level" id="delete-action"><button class="button-primary">'.__('Add Level', 'ignitiondeck').'</button></span> &nbsp;&nbsp; <span deletelevel="1" class="ig-add-level"> <button class="submitdelete deletion">'.__('Delete Last Level', 'ignitiondeck').'</button></span> </div>';
				break;
