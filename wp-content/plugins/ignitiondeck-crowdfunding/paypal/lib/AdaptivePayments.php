...
class AdaptivePayments extends CallerServices {
	...
	function GetFundingPlans($GetFundingPlansRequest,$SerializeOption=null, $isRequestString = false)
	{
		try {
			if($isRequestString) {
				return parent::callWebService($GetFundingPlansRequest, 'AdaptivePayments/GetFundingPlans');
			}
			else {
				return $this->callAPI($GetFundingPlansRequest, 'AdaptivePayments/GetFundingPlans',$SerializeOption);
			}
			...
			throw new FatalException('Error occurred in GetFundingPlans method');
		}
			
			
	}
function ConfirmPreApproval($ConfirmPreApprovalRequest,$SerializeOption=null, $isRequestString = false)
	{
		try {
			if($isRequestString) {
				return parent::callWebService($ConfirmPreApprovalRequest, 'AdaptivePayments/ConfirmPreApproval');
			}
			else {
				return $this->callAPI($ConfirmPreApprovalRequest, 'AdaptivePayments/ConfirmPreApproval',$SerializeOption);
			}
			...
			throw new FatalException('Error occurred in ConfirmPreApproval method');
		}
			
			
	}
function GetAllowedFundingSources($GetAllowedFundingSourcesRequest,$SerializeOption=null, $isRequestString = false)
	{
		try {
			if($isRequestString) {
				return parent::callWebService($GetAllowedFundingSourcesRequest, 'AdaptivePayments/GetAllowedFundingSources');
			}
			else {
				return $this->callAPI($GetAllowedFundingSourcesRequest, 'AdaptivePayments/GetAllowedFundingSources',$SerializeOption);
			}
			...
			throw new FatalException('Error occurred in GetAllowedFundingSource method');
		}
			
			
	}
function GetAvailableShippingAddress($GetAvailableShippingAddressRequest,$SerializeOption=null, $isRequestString = false)
	{
		try {
			if($isRequestString) {
				return parent::callWebService($GetAvailableShippingAddressRequest, 'AdaptivePayments/GetAvailableShippingAddresses');
			}
			else {
				return $this->callAPI($GetAvailableShippingAddressRequest, 'AdaptivePayments/GetAvailableShippingAddresses',$SerializeOption);
			}
			...
			throw new FatalException('Error occurred in GetAvailableShippingAddress method');
		}
			
			
	}
function GetShippingAddress($GetShippingAddressRequest,$SerializeOption=null, $isRequestString = false)
	{
		try {
			if($isRequestString) {
				return parent::callWebService($GetShippingAddressRequest, 'AdaptivePayments/GetShippingAddresses');
			}
			else {
				return $this->callAPI($GetShippingAddressRequest, 'AdaptivePayments/GetShippingAddresses',$SerializeOption);
			}
			...
			throw new FatalException('Error occurred in GetShippingAddress method');
		}
