								...
								<table>
									...
									<tr>
										...
										<td colspan="2"><select name="currency_code_default" id="currency_code_default">
											<option <?php echo ((isset($default_currency) && $default_currency->currency_code == "USD") ? 'selected="selected"' : '')?> value="USD"><?php _e('U.S. Dollar', 'ignitiondeck'); ?></option>
											<option <?php echo ((isset($default_currency) && $default_currency->currency_code == "AUD") ? 'selected="selected"' : '')?> value="AUD"><?php _e('Australian Dollar', 'ignitiondeck'); ?></option>
											<option <?php echo ((isset($default_currency) && $default_currency->currency_code == "CAD") ? 'selected="selected"' : '')?> value="CAD"><?php _e('Canadian Dollar', 'ignitiondeck'); ?></option>
											<option <?php echo ((isset($default_currency) && $default_currency->currency_code == "CZK") ? 'selected="selected"' : '')?> value="CZK"><?php _e('Czech Koruna', 'ignitiondeck'); ?></option>
											<option <?php echo ((isset($default_currency) && $default_currency->currency_code == "DKK") ? 'selected="selected"' : '')?> value="DKK"><?php _e('Danish Krone', 'ignitiondeck'); ?></option>
											<option <?php echo ((isset($default_currency) && $default_currency->currency_code == "EUR") ? 'selected="selected"' : '')?> value="EUR"><?php _e('Euro', 'ignitiondeck'); ?></option>
											<option <?php echo ((isset($default_currency) && $default_currency->currency_code == "HKD") ? 'selected="selected"' : '')?> value="HKD"><?php _e('Hong Kong Dollar<', 'ignitiondeck'); ?>/option>
											<option <?php echo ((isset($default_currency) && $default_currency->currency_code == "HUF") ? 'selected="selected"' : '')?> value="HUF"><?php _e('Hungarian Forint', 'ignitiondeck'); ?></option>
											<option <?php echo ((isset($default_currency) && $default_currency->currency_code == "ILS") ? 'selected="selected"' : '')?> value="ILS"><?php _e('Israeli New Sheqel', 'ignitiondeck'); ?></option>
											<option <?php echo ((isset($default_currency) && $default_currency->currency_code == "JPY") ? 'selected="selected"' : '')?> value="JPY"><?php _e('Japanese Yen', 'ignitiondeck'); ?></option>
											<option <?php echo ((isset($default_currency) && $default_currency->currency_code == "MXN") ? 'selected="selected"' : '')?> value="MXN"><?php _e('Mexican Peso', 'ignitiondeck'); ?></option>
											<option <?php echo ((isset($default_currency) && $default_currency->currency_code == "MYR") ? 'selected="selected"' : '')?> value="MYR"><?php _e('Malaysian Ringgit', 'ignitiondeck'); ?></option>
											<option <?php echo ((isset($default_currency) && $default_currency->currency_code == "NOK") ? 'selected="selected"' : '')?> value="NOK"><?php _e('Norwegian Krone', 'ignitiondeck'); ?></option>
											<option <?php echo ((isset($default_currency) && $default_currency->currency_code == "NZD") ? 'selected="selected"' : '')?> value="NZD"><?php _e('New Zealand Dollar', 'ignitiondeck'); ?></option>
											<option <?php echo ((isset($default_currency) && $default_currency->currency_code == "PHP") ? 'selected="selected"' : '')?> value="PHP"><?php _e('Philippine Peso', 'ignitiondeck'); ?></option>
											<option <?php echo ((isset($default_currency) && $default_currency->currency_code == "PLN") ? 'selected="selected"' : '')?> value="PLN"><?php _e('Polish Zloty', 'ignitiondeck'); ?></option>
											<option <?php echo ((isset($default_currency) && $default_currency->currency_code == "GBP") ? 'selected="selected"' : '')?> value="GBP"><?php _e('Pound Sterling', 'ignitiondeck'); ?></option>
											<option <?php echo ((isset($default_currency) && $default_currency->currency_code == "SGD") ? 'selected="selected"' : '')?> value="SGD"><?php _e('Singapore Dollar', 'ignitiondeck'); ?></option>
											<option <?php echo ((isset($default_currency) && $default_currency->currency_code == "SEK") ? 'selected="selected"' : '')?> value="SEK"><?php _e('Swedish Krona', 'ignitiondeck'); ?></option>
											<option <?php echo ((isset($default_currency) && $default_currency->currency_code == "CHF") ? 'selected="selected"' : '')?> value="CHF"><?php _e('Swiss Franc', 'ignitiondeck'); ?></option>
											<option <?php echo ((isset($default_currency) && $default_currency->currency_code == "TWD") ? 'selected="selected"' : '')?> value="TWD"><?php _e('New Taiwan Dollar', 'ignitiondeck'); ?></option>
											<option <?php echo ((isset($default_currency) && $default_currency->currency_code == "THB") ? 'selected="selected"' : '')?> value="THB"><?php _e('Thai Baht', 'ignitiondeck'); ?></option>
											<option <?php echo ((isset($default_currency) && $default_currency->currency_code == "TRY") ? 'selected="selected"' : '')?> value="TRY"><?php _e('Turkish Lira', 'ignitiondeck'); ?></option>
											<option <?php echo ((isset($default_currency) && $default_currency->currency_code == "BRL") ? 'selected="selected"' : '')?> value="BRL"><?php _e('Brazilian Real', 'ignitiondeck'); ?></option>
										</select></td>
									</tr>
									<tr>
										<td>&nbsp;</td>
										<td><a href="#" id="check-all-settings"><?php _e('Check All', 'ignitiondeck'); ?></a></td>
										<td><a href="#" id="clear-all-settings"><?php _e('Clear All', 'ignitiondeck'); ?></a></td>
									</tr>
									<tr>
