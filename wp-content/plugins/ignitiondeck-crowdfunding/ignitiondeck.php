...
$ign_db_version = "1.5.12";
$ign_installed_ver = get_option( "ign_db_version" );

add_action( 'plugins_loaded', 'ignitiondeck_init');
...
function add_ty_url() {
	add_meta_box("add_ty_url_box", __("Thank You Project URL", "ignitiondeck"), "add_ty_url_box", "ignition_product", "side", "default");
}
