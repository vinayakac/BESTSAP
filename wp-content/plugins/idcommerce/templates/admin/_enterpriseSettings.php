					...
					<div class="postbox">
						...
						<div class="inside">
							<form method="POST" action="" id="idc_enterprise_settings" name="idc_enterprise_settings">
								...
								<div class="form-select">
									<label for="fee_type"><?php _e('Primary Receiver', 'memberdeck'); ?></label>
									<div>
										<select name="primary_receiver" id="primary_receiver">
											<option value="site-admin" <?php echo (empty($enterprise_settings['primary_receiver']) || $enterprise_settings['primary_receiver'] == 'site-admin' ? 'selected="selected"' : ''); ?>><?php _e('Site Admin', 'memberdeck'); ?></option>
											<option value="creator" <?php echo (isset($enterprise_settings['primary_receiver']) && $enterprise_settings['primary_receiver'] == 'creator' ? 'selected="selected"' : ''); ?>><?php _e('Project Creator', 'memberdeck'); ?></option>
										</select>
									</div>
								</div>
								<div class="submit">
