										...
										<ul>
											...
											<li>
												<ul>
													...
													?>
													<li><input type="checkbox" id="select-<?php echo $project->id; ?>-<?php echo $i; ?>" class="level-select select-<?php echo $project->id; ?>" data-level="<?php echo $i; ?>" data-owner="<?php echo $owner; ?>" <?php echo ($is_level_available ? '' : 'disabled="disabled"'); ?>/><label for="select-<?php echo $project->id; ?>-<?php echo $i; ?>"><?php echo $level_title.' '.apply_filters('id_display_currency', apply_filters('id_price_format', $level_price, $post_id), $post_id); ?></label></li>
													<?php } ?>
												</ul>
											</li>
										</ul>
