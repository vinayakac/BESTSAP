<div class="wrap memberdeck">
	<div class="icon32" id="icon-md"></div><h2 class="title"><?php _e('IgnitionDeck Commerce Settings', 'memberdeck'); ?></h2>
	<div class="help">
		...
		<div class="postbox-container" style="width:49%; margin-right: 2%">
			<div class="metabox-holder">
				<div class="meta-box-sortables" style="min-height:0;">
						...
						<div class="inside">
							...
							<form method="POST" action="" id="idmember-settings" name="idmember-settings">
								...
								<div class="columns" style="width: 47%;">
									...
									<?php if ($combined_purchases && isset($es) && $es == '1') { ?>
										<div class="form-input inline combine-products-checkbox">
										...
										<div class="form-input combine-products-selection hide">
									...
									<?php } ?>
									<div class="form-input inline">
										<input type="checkbox" name="custom_message" id="custom_message" value="1"/> <label for="custom_message"><?php _e('Custom Email', 'memberdeck'); ?></label>
									</div>
								</div>
								<div class="submit">
									...
									<div class="form-input">
										<ul>
											...
											<li>
												...
												<label for="image-link"><?php _e('Image', 'memberdeck'); ?></label>
												<input type="button" id="add-download-image" class="button-primary" value="<?php _e('Add Image', 'memberdeck'); ?>" />
												<input type="button" id="remove-download-image" class="button-primary hide" value="<?php _e('Remove Image', 'memberdeck'); ?>" />
												<input type="hidden" id="image-link" name="image-link" value=""/>
												<img id="download-image-thumnail" src="" class="hide" width="100%" />
											</li>
										</ul>
									</div>
									<div class="form-input">
					...
					<div class="postbox">
						<h3 class="hndle"><span><?php _e('Currency Settings', 'memberdeck'); ?></span><a id="currency-settings" class="md_help_link">help</a></h3>
						<div id="currency-settings-help" class="info inside" style="display: none;">
							<?php _e('Settings for the currency used by IDC', 'memberdeck'); ?><br><br>
  							<strong><?php _e('Global Currency', 'memberdeck'); ?></strong>: <?php _e('The currency to be shared between IDC and IDCF', 'memberdeck'); ?>
						...
						<div class="inside">
							<form method="POST" action="" id="idmember-credits" name="idmember-credits">
								...
								<div class="form-input inline">
									...
									<label for="enable_credits"><?php _e('Enable Credits', 'memberdeck'); ?></label><br />
									<small style="display:none" class="virtual-currency-selected error"><em><?php _e('Global Currency is currently Virtual Currency ('.apply_filters('idc_credits_label', 'Credits', true).'). Please select another currency first.', 'memberdeck'); ?></em></small>
								</div>
								<div class="form-input idc-credits-field" <?php echo (isset($enable_credits) && $enable_credits == 1 ? '' : 'style="display:none;"') ?>>
					...
					<div class="postbox">
						...
						<div class="inside">
							<form method="POST" action="" id="idmember-dash" name="idmember-dash">
								...
								<div class="form-input" <?php echo (empty($show_terms) || !$show_terms ? 'style="display: none;"' : ''); ?>>
						...
						<div class="inside">
							<form method="POST" action="">
								<div class="columns">
									...
									<p><?php _e('Sign up for a free ', 'memberdeck'); ?><a href="http://sendgrid.com/">Sendgrid</a> <?php _e('account to start sending transactional email.', 'memberdeck'); ?></p>
									<div class="form-input inline">
										<label for="sendgrid_api_key"><?php _e('Sendgrid API Key', 'memberdeck'); ?></label>
										<input type="text" name="sendgrid_api_key" id="sendgrid_api_key" value="<?php echo (isset($sendgrid_api_key) ? $sendgrid_api_key : ''); ?>"/>
									</div>
									<div class="form-input inline">
