	...
	<div class="postbox-container" style="width:65%; margin-right: 3%">
		<div class="metabox-holder">
			<div class="meta-box-sortables" style="min-height:0;">
				<div class="postbox">
					<h3 class="hndle"><span><?php _e('Active Gateway Settings', 'memberdeck'); ?></span></h3>
					<div class="inside">
						<form method="POST" action="" id="gateway-settings" name="gateway-settings">
							...
							<div class="columns" style="width: 29%; padding-right: 2.5%; margin-right: 2.5%; <?php if (!is_idc_free()) { echo 'border-right: 1px solid #C8D3DC;"'; } ?>>
								...
								<?php } ?>
								<?php if (!is_idc_free() && function_exists('is_id_pro') && is_id_pro()) { ?>
								<div class="form-input inline">
							...
							<div class="columns" style="width: 29%; padding-right: 2.5%; margin-right: 2.5%; border-right: 1px solid #C8D3DC;">
								...
								<div class="form-input">
									...
									<select id="stripe_currency" name="stripe_currency" data-selected="<?php echo (isset($stripe_currency) ? $stripe_currency : '0') ?>">
							...
							<div class="columns" style="width: 29%;">
								...
								<div class="form-input inline">
									<input type="checkbox" name="efd" id="efd" value="1" class="cc-gateway-chkbox" <?php echo (isset($efd) && $efd == 1 ? 'checked="checked"' : ''); ?>/>
							...
							<div class="columns" style="width: 29%; margin-top: 49px;">
								<p>
				            ...
				            <div class="columns" style="width: 29%; padding-left: 2.5%; margin-left: 2.5%; margin-top: 40px; border-left: 1px solid #C8D3DC;">
								...
								<div class="form-input inline">
									<input type="checkbox" name="enablelemonway" id="enablelemonway" value="1" class="cc-gateway-chkbox" <?php echo (isset($enablelemonway) && $enablelemonway == 1 ? 'checked="checked"' : ''); ?>/>
									<label for="enablelemonway"><?php _e('Enable LemonWay', 'memberdeck'); ?></label>
								</div>
							</div>
							<?php } ?>
							<?php do_action('idc_gateway_columns_after'); ?>
			...
			<div class="meta-box-sortables" style="min-height:0;">
				<div class="postbox info">
					...
					<div class="inside">
						...
						<p><?php _e('Only one credit card gateway (Stripe, First Data, Authorize.Net) may be active at one time.', 'memberdeck'); ?></p>
						<strong><?php _e('Currencies', 'memberdeck'); ?>:</strong>
						<p><?php _e('Stripe transactions may be settled in the currencies listed as available on their website.', 'memberdeck'); ?></p>
						<strong><?php _e('Recurring Payments', 'memberdeck'); ?>:</strong>
						<p><?php _e('To use subscriptions, please enable Stripe, Paypal, Authorize.Net or Coinbase.', 'memberdeck'); ?></p>
						...
						<p><strong>http://[mydomain.com]/?memberdeck_notify=stripe</strong></p>
						...
						<p><strong>http://[mydomain.com]/?memberdeck_notify=pp</strong></p>
