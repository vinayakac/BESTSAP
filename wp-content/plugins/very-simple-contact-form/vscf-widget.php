...
class vscf_widget extends WP_Widget {
	...
	function form( $instance ) {
		...
		<p><?php _e( 'Info about attributes', 'very-simple-contact-form' ); ?>: <a href="https://wordpress.org/plugins/very-simple-contact-form/installation" target="_blank"><?php _e( 'Installation', 'very-simple-contact-form' ); ?></a></p>
		<?php 
	}
